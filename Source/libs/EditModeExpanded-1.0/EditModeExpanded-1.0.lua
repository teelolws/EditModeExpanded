...
local MAJOR, MINOR = "EditModeExpanded-1.0", 4
...
EditModeExpandedSettingSliderMixin = CreateFromMixins(EditModeSettingSliderMixin)
...
function EditModeExpandedSettingSliderMixin:OnSliderValueChanged(value)
